...
import cafe.adriel.chroma.model.tuner.Tone
...
class SettingsManager(
    ...
    fun getChromaticScale(): List<ChromaticNote> {
        return ChromaticScale.values()
            .map { ChromaticNote(it, it.frequency * (settings.referencePitchOption.freq / 440f)) }
    }
